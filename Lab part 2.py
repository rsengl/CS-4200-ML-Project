...
print('The accuracy for the linear model is' , model_linear.score(x_test, y_test))
print('The accuracy for the SGD model is' , model_sgd.score(x_test, y_test))
...
#Q3
#20%
x_train2, x_test2, y_train2, y_test2 = train_test_split(x_data, y_data, test_size  = .20, random_state = 1)
...
#40% testing
x_train4, x_test4, y_train4, y_test4 = train_test_split(x_data, y_data, test_size  = .40, random_state = 1)
...
#60% testing
x_train6, x_test6, y_train6, y_test6 = train_test_split(x_data, y_data, test_size  = .60, random_state = 1)
...
#80% testing
x_train8, x_test8, y_train8, y_test8 = train_test_split(x_data, y_data, test_size  = .80, random_state = 1)
...
print("The MSE is:", mean_squared_error(y_test, y_prediction))
